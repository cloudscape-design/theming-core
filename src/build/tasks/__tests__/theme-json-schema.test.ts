...
import { presetWithValidSchema } from '../../../__fixtures__/common.js';
import type { ThemeJson, TokenJson } from '../theme-json.js';
import { validateJson, getThemeJSONSchema } from '../theme-json-schema.js';
